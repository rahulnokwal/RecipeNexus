...
const Header = () => {
  return (
    <div className="absolute top-0 left-0 w-full">
      <div className="w-full px-4 py-1.5 border-b border-emerald-500 flex justify-between items-center">
        <div className="flex items-center gap-3 group cursor-pointer py-1.5">
          ...
          <span className="text-2xl font-light tracking-tighter text-white font-['Outfit'] whitespace-nowrap">
            reci<span className="font-black text-emerald-600 mr-0.5">.</span>
            nexus
          </span>
        </div>
